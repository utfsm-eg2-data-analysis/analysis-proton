void get_acc_hists_Pt2(TString tar){
...
TString targ;
  ...
  TString infile = "hists_Pt2_"+targ+".root";
  TFile *hists_f = TFile::Open(infile);

  TString outf_name = "acc_hists_Pt2_"+targ+".root";
  TFile *outf = new TFile(outf_name,"RECREATE");

  TH1F *hist_acc = new TH1F("hist_acc", "hist_acc", 30, 0.0, 2.0);

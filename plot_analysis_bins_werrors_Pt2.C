...
void plot_analysis_bins_werrors_Pt2(/*TString tar,Int_t a, Int_t b*/){
...
l->SetLineColor(colors[0]);
    ...
    for(int k=1;k<4;k++){
       targ=targets[k];
       TString hist_file_name = "/home/juan/analysis-proton/Histograms/acc_ratio_hists_Pt2_"+targ;
       TString outf_name = hist_file_name+".root";
       TFile *outf = TFile::Open(outf_name);
       TString hist_name = "hist_acc_ratio";
     ...
     hist->GetXaxis()->SetRangeUser(0.0,2.1);

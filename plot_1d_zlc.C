void plot_1d_zlc(TString tar,Int_t r){
...
Double_t cuts_zlc_b[30] = {0.000000,0.010000,0.020000,0.030000,0.040000,0.050000,0.060000,0.070000,0.080000,0.090000,0.100000,0.110000,0.120000,0.130000,0.140000,0.150000,0.160000,0.170000,0.180000,0.190000,0.200000,0.210000,0.220000,0.230000,0.240000,0.250000,0.260000,0.270000,0.280000,0.290000};

Double_t cuts_zlc_t[30] ={0.010000,0.020000,0.030000,0.040000,0.050000,0.060000,0.070000,0.080000,0.090000,0.100000,0.110000,0.120000,0.130000,0.140000,0.150000,0.160000,0.170000,0.180000,0.190000,0.200000,0.210000,0.220000,0.230000,0.240000,0.250000,0.260000,0.270000,0.280000,0.290000,0.300000};
...
TString tree_name = "Tree_" + targ +"_"+ run +"_zlc";
TString outf_name =tree_name+".root";
TFile *outf = new TFile(outf_name,"RECREATE"); /* Save output plots in a root file */

 TH1F *zlc_Gen = new TH1F("zlc_Gen","zlc_Gen",30,0.0,0.3);
 TH1F *zlc_Rec = new TH1F("zlc_Rec","zlc_Rec",30,0.0,0.3);

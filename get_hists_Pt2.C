...
void get_hists_Pt2(TString tar){
  ...
  TString outf_name = "hists_Pt2_"+targ+".root";
  TFile *outf = new TFile(outf_name,"RECREATE");


  TH1F *hist_Rec = new TH1F("hist_Rec", "hist_Rec", 30, 0.0, 2.0);
  
  TH1F *hist_Gen = new TH1F("hist_Gen", "hist_Gen", 30, 0.0, 2.0);
